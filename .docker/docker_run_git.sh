...
find /var/www/html/tools/assets -name "*.sh" -type f -exec dos2unix {} \; 2>/dev/null || true
find /var/www/html/.docker/install -name "*.sh" -type f -exec dos2unix {} \; 2>/dev/null || true

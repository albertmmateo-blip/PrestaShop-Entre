...
✅ **This functionality works with both Classic and Hummingbird themes** (and any other PrestaShop theme that follows standard conventions).

The meter-based quantity system is built into PrestaShop's shared core JavaScript (`themes/_core/js/`) and is automatically available for all themes without any theme-specific configuration.

See [THEME_COMPATIBILITY.md](THEME_COMPATIBILITY.md) for detailed information about theme compatibility, testing, and troubleshooting.
